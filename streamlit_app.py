...
st.image("Asset 4@2x-8 (5).png", width=200)
st.image("Kein Titel (389 x 129 px) (389 x 129 px) (3).png", width=300)
...
st.markdown("---")
st.markdown(
    "💡 Entwickelt von **[Talify](https://www.talify.de/)** | 🔗 [Mehr erfahren](https://www.talify.de/)",
